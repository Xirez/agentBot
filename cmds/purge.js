...
module.exports.run = async (bot, message, args) => {
    ...
    message.channel.bulkDelete(args[0]).then(() => {
        message.channel.send(`Cleared ${args[0]} messages. Please dont spam this command, Discord's API works at the pace of a sloth. When this msg is gone, feel free to purge again.`).then(msg => msg.delete(12000));
        // add a catch to the msg deletion promise if someone purge the bots above msg.
